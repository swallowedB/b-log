...
export default function SiteFooter() {
  return (
    <footer className="flex gap-5 items-center w-full bg-background/70 backdrop-blur-sm mt-20 border-t border-foreground/10 justify-between px-5 md:px-10 py-4">
      <div className="flex items-center gap-5">
        ...
        >
          <FaGithub />
          <span className="text-foreground/60 text-[10px] md:text-sm">@swallowedB</span>
        </a>
      </div>

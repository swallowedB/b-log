...
export default function SiteFooter() {
  return (
    <footer className="flex gap-5 items-center w-full backdrop-blur-sm bg-transparent border-t border-foreground/10 justify-between px-5 md:px-10 py-4 mt-20">
      <a
